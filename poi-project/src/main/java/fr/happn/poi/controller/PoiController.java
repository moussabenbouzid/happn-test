...
public class PoiController {
	...
	public Result calculPoisByZone(@PathVariable float minLat,@PathVariable float maxLat,
			@PathVariable float mintLon,@PathVariable float maxLon, HttpServletRequest request, HttpServletResponse response){
		...
		Result result = service.calculPoisByZone(minLat, maxLat, mintLon, maxLon, listPois);
		logger.debug("FIN : Methode poisbyzone");
		return result;
	}
